...
<head>
    ...
    <!-- Google Fonts -->
    <link href="https://fonts.googleapis.com/css2?family=Domine:wght@400;600;700&family=Arimo:wght@400;600;700&display=swap" rel="stylesheet">

    <!-- Custom CSS (versioned — browser caches between deploys) -->
    <link rel="stylesheet" href="<?php echo ASSETS_URL; ?>/css/style.css?v=<?php echo ASSET_VERSION; ?>">
    <?php if ($lang === 'ar'): ?>
    <link rel="stylesheet" href="<?php echo ASSETS_URL; ?>/css/rtl.css?v=<?php echo ASSET_VERSION; ?>">
    <?php endif; ?>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav <?php echo ($lang === 'ar') ? 'me-auto' : 'ms-auto'; ?>" style="gap: 8px;">
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-enhanced <?php echo isActive('blog.php'); ?>" href="<?php echo url('blog.php'); ?>" style="color: #602234 !important; padding: 8px 16px !important; font-size: 15px; font-weight: 500; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); position: relative; z-index: 2;">
