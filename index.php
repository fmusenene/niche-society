...
if (!file_exists($config_file)) {
    // Define essential constants if they don't exist
    if (!defined('SITE_NAME')) define('SITE_NAME', 'Niche Society');
    if (!defined('SITE_URL')) define('SITE_URL', 'http://localhost/niche-society-main');
    if (!defined('ASSETS_URL')) define('ASSETS_URL', SITE_URL . '/assets');
    if (!defined('CONTACT_EMAIL')) define('CONTACT_EMAIL', 'info@niche-society.com');
...
if (!defined('SUPPORTED_LANGUAGES')) define('SUPPORTED_LANGUAGES', ['ar', 'en']);
    ...
    try {
        ...
        error_log("Config loading error (non-critical for homepage): " . $e->getMessage());
    }
}
